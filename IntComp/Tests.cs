...
namespace JakubSturc.AdventOfCode2019.IntComp
{
    public partial class Tests
    {
        ...
        {
            var interpreter = new Computer(initial, Enumerable.Empty<long>());
        ...
        public void Day5_IO_Read_Samples()
        {
            ...
            var interpreter = new Computer(program, new long[] { 42 });
            _ = interpreter.Run().ToList();
        ...
        public void Day5_IO_Write_Samples()
        {
            ...
            var interpreter = new Computer(program, Enumerable.Empty<long>());
        ...
        {
            var interpreter = new Computer(program, input);
        ...
        public void Day9_PartI_Quine()
        {
            ...
            var interpreter = new Computer(quine, Enumerable.Empty<long>());
