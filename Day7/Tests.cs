...
namespace JakubSturc.AdventOfCode2019.Day7
{
    public partial class Tests
    {
        ...
        public void Day7_PartI_Sample(int[] program, int[] sequence, int expected)
        {
            var amplifier = new Amplifier(program, sequence, new[] { 0 });
        ...
        [InlineData(new[] { 3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,
                            27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5 }, new[] { 9,8,7,6,5 }, 139629729)]
        ...
        public void Day7_PartII_Sample(int[] program, int[] sequence, int expected)
        {
            var amplifier = new Amplifier(program, sequence, new[] { 0 });
            var actual = amplifier.Run();
